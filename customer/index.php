...
<head>
    ...
    <body style="background-color:#12004e">
    
    <div id="loginbox" style="background-color:#12004e">            
            <form id="loginform" class="form-vertical" method="POST" action="#" style="background-color:#12004e">
				 <div class="control-group normal_text" style="background-color:#12004e"> <h3><img src = "img/icontest3.png"></img></h3></div>
                <div class="control-group" style="background-color:#12004e">
                    <div class="controls" style="background-color:#12004e;">
                        <div class="main_input_box" style="background-color:#12004e">
                ...
                <div class="form-actions" style="background-color:#12004e">
                    <span class="pull-left" style="background-color:#12004e"><a href="#" class="flip-link btn btn-info" id="to-recover">Join Now!</a></span>
                    <span class="pull-right" style="background-color:#12004e"><button type="submit" name="login" class="btn btn-success" />Login</button></span>
                </div>
                <div class="g" style="background-color:#12004e">
