...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom">Home</a> <a href="#" class="tip-bottom">Manage Equipments</a> <a href="#" class="current">Update Equipment</a> </div>
...
<form role="form" action="index.php" method="POST">
    <?php 
            ...
            //update query
            $qry = "update equipment set name='$name', amount='$totalamount', description='$description', quantity='$quantity' where id='$id'";
