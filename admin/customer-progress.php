...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom">Home</a> <a href="customer-progress.php" class="current">Customer Progress</a> </div>
    <h1 class="text-center">Update Customer's Progress</h1>
  </div>
