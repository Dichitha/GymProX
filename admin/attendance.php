...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"> Home</a> <a href="attendance.php" class="current">Manage Attendance</a> </div>
           ...
           <tbody> 
            ...
            <?php
                ...
                if ($num_count > 0) {
                    ...
                    $curr_date = $row_exist['curr_date'] ?? ''; // Use the null coalescing operator to handle null value
                } else {
                    $curr_date = ''; // Handle the case when no data is found
                }
              ...
              ?>
                ...
                <div class='text-center'><a href='actions/delete-attendance.php?id=<?php echo $row['user_id'];?>'><button class='btn btn-danger'>Check Out</button> </a></div>
                </td>
            ...
            <?php } else {
                ...
                <td><div class='text-center'><a href='actions/check-attendance.php?id=<?php echo $row['user_id'];?>'><button class='btn btn-info'>Check In</button> </a></div></td>
